...
public class Value {
      ...
      public static double POCKET_RADIUS = 2.2 * SCALE;
      ...
      public static double pocketY1 = BOARD_POSITION_CENTER_Y + 125*SCALE/17 - BALL_RADIUS;
      public static double pocketY2 = BOARD_POSITION_CENTER_Y +BOARD_Y - 125*SCALE/17 + BALL_RADIUS;
