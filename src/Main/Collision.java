      ...
      public boolean isContact() {
            ...
            if (deltaX * deltaX + deltaY * deltaY <= radiusSum * radiusSum) {
                  if (deltaX * (ball2.getVelocityX() - ball1.getVelocityX())
                        ...
                        if(ball1.getID() == 0 && Rules.firstHitBallNum == -1) Rules.firstHitBallNum =ball2.getID();
                        else if(ball2.getID() == 0 && Rules.firstHitBallNum == -1) Rules.firstHitBallNum =ball1.getID();
                        return true;
                  }
            }
            return false;
